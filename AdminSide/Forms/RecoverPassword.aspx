<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecoverPassword.aspx.cs" EnableEventValidation="false" Inherits="PatelTeaSource.AdminSide.Forms.RecoverPassword" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Recover Password - Patel Tea Packers</title>
...
<body>
   <body data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page">
                                ...
                                <div class="card-header no-border">
                                    <div class="card-title text-xs-center">
                                        <div class="p-1">
                                           ...
                                           <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Create New Password.</span></h6>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form class="form-horizontal form-simple" action="index.html" novalidate>
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                ...
                                                <asp:TextBox ID="txtNewPassword" TextMode="Password" runat="server" class="form-control form-control-lg input-lg" placeholder="Your New Password" required></asp:TextBox>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                ...
                                                <asp:TextBox ID="txtConfirmPassword" TextMode="Password" runat="server" class="form-control form-control-lg input-lg" placeholder="Your Password Again" required></asp:TextBox>
                                                <div class="form-control-position">
                                                      <i class="icon-key3"></i>
                                                </div>
                                              ...
                                              <br />
                                                   <asp:Button ID="btnResetpassword" runat="server" OnClick="btnResetpassword_Click" class="btn btn-primary btn-lg btn-block" Text="Reset Password" />
                                              <br />
                                        </form>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        var txtConfirmPwdReset = $("#" + "<%= txtConfirmPassword.ClientID %>");
